...
int main() {
  ...
  std::cout << "Cas GS: " << time_duration.count() << " sec" << std::endl;
...
#pragma omp critical
  ...
  std::cout << "Cas GS paralelni: " << time_duration_omp.count() << " sec" << std::endl;
  ...
  std::cout << "Maks. temperatura: " << max_T << "\370C" << endl;
